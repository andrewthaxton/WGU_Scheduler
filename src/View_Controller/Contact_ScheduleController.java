...
/**
 * The controller for the contacts schedule screen.
 */

public class Contact_ScheduleController extends ListManager implements Initializable {

    @FXML
    private Label contactScheduleTitleLabel;
    ...
    /**
     * Filters the appointments by the selected contact
     * @param event
     */
    ...
    void onContactCombo(ActionEvent event) {
        ...
        for(Appointment a : ListManager.getAppointments()){
            if(a.getContactId() == selectedContact.getId()){
    ...
    /**
     * Initializes the table with all appointments and the combo box with the contacts.
     * @param url
    ...
    public void initialize(URL url, ResourceBundle resourceBundle){
        ...
        contactScheduleTableview.setItems(ListManager.getAppointments());
